...
if(isset($_GET['CURRENT_DATE'])){
   ...
   $sql = "SELECT * FROM tbl_logged ta INNER JOIN tbl_member ts ON ta.RFID=ts.RFID WHERE LOGDATE ='".$_GET['CURRENT_DATE']."' ORDER BY LOGDATE DESC";
...
foreach($data as $key=>$value){
    ...
    $output .= '<tr>  
        ...
        $filename = "daily_logs_export_".date('Y-m-d') . ".xls";         
