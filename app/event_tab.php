...
<div class="wrapper">
  ...
  background-size: cover;">
        <div class="container">
          ...
          <p class="lead text-mutedd">Nueva Ecija University of Science and Technology - Municipal Government of Talavera</p>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          ...
          <div class="card-footer text-muted">
              <div class="float-right">
				   <a href="scan_getpass.php?&code=<?=urlencode(base64_encode($code));?>" class="btn bg-primary btn-sm"><i class="fa-solid fa fa-arrow-left"></i> BACK</a>
          </div>
