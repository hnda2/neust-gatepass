  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>All Summary Logs</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Gatetpass Record</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
             ...
             <h3 class="card-title"> 
             <div class="btn-group">
             <a href="getpass_logs_all_export.php?all" class="btn btn-success btn-sm"><i class="fa fa-file-excel"></i> SAVE TO EXCEL</a>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped table-hover">
                  ...
                  <tbody>
                    ...
                    $sql = "SELECT * FROM tbl_member tm INNER JOIN tbl_logged tr ON tm.RFID=tr.RFID ORDER BY tr.LOGDATE DESC";
