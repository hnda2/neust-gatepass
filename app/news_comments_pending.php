            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
				        	<?php
                    $sql = "SELECT *,tn.ID as newsID, tc.ID as commID FROM tbl_news tn INNER JOIN tbl_comments tc ON tn.ID=tc.NEWS_ID WHERE STATUS=0 ORDER BY tn.POSTING_DATE ASC";
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <div class="btn-group">
                            <button data-id="<?=$row['commID'];?>" onclick="confirmApprovedComment(this);" class="btn bg-navy btn-sm"><span class="fa fa-thumbs-up"></span></button>
...
<script>
      ...
      function confirmApprovedComment(self) {
          var id = self.getAttribute("data-id");
          document.getElementById("form-approved-comments").id.value = id;
          $("#myModalApprovedComment").modal("show");
      }
